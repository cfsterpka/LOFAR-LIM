...
def FindRFI(TBB_in_file, block_size, initial_block, num_blocks, max_blocks=None, verbose=False, figure_location=None, lower_frequency=10E6, upper_frequency=90E6, num_dbl_z=100):
    ...
    #print("allowed_num_antennas = ", allowed_num_antennas)
    #print("max_allowed_antennas = ", max_allowed_antennas)
    can_be_ref_antenna = (allowed_num_antennas == max_allowed_antennas )



    #print("can_be_ref = ", can_be_ref_antenna)
...
#    print(average_power)
    ...
    #print("sorted_by_power = ", sorted_by_power)

    ref_antenna = None

    for ant_i in sorted_by_power[int(len(sorted_by_power)*0.5):]:
    #for ant_i in sorted_by_power[::-1]:
        #print("checking antenna: "+ str(ant_i)+ " to see if it can be ref")
    ...
    if ref_antenna is None:
      print("\nNo ref antennas found for station:"+ TBB_in_file.get_station_name())
      print("\n")
      return
